...
UtmCookie = (function() {
  ...
  UtmCookie.prototype.initialLandingPageUrl = function() {
    ...
    return decodeURIComponent(this.readCookie('initial_landing_page'));
  };
...
UtmForm = (function() {
  function UtmForm(options) {
    ...
    this._utmParamsMap = {};
    this._utmParamsMap.gclid = options.vtm_gclid_field || 'gclid';
    this._utmParamsMap.msclkid = options.vtm_msclkid_field || 'msclkid';
    this._utmParamsMap.zc_gad = options.vtm_msclkid_field || 'zc_gad';
  ...
  UtmForm.prototype.addFormElem = function(form, fieldName, fieldValue) {
   ...
   UtmForm.prototype.getFieldEl = function(fieldName, fieldValue) {
    ...
    // if it does, then we update the value of the field
        ...
        if (inputExist) { // if the input exists
          inputExist.value = fieldValue; // update the value of the input
        }
    // check if the form already has a hidden input field named zc_gad.
